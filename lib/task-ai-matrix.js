...
export const TASKS = [
  ...
  },
  {
    ...
    label: "Müzik Üretme",
    icon: "Music",
    description: "Şarkı, beste, arka plan müziği üretimi",
    questions: [
      {
        id: "genre",
        label: "Hangi tür/ruh hali?",
        placeholder: "örn: pop, lo-fi, hüzünlü, enerjik...",
      },
      {
        id: "lyrics",
        label: "Şarkı sözü konusu ne? (enstrümantal ise boş bırak)",
        placeholder: "örn: ayrılık, yaz tatili, motivasyon...",
      },
    ],
  },
  {
...
export const AI_TOOLS = {
  ...
  muzica: {
    ...
    strengths: "Türkçe şarkı sözü kalitesi ve Türk enstrümanlarında en güçlü seçenek",
    goldenTip:
      "Müzik türünü (pop, türkü, rap vb.) ve şarkı sözü temasını net belirt, Türkçe yaz.",
    pricing: "freemium",
    priceNote: "Kayıtta 1 ücretsiz şarkı kredisi, sonrası ücretli",
  },
  suno: {
    name: "Suno AI",
    vendor: "Suno",
    color: "#A855F7",
    bestFor: ["music-generation"],
    strengths: "Vokalli şarkı üretiminde pazar lideri, geniş tür ve dil desteği",
    goldenTip:
      "Tür, ruh hali ve şarkı sözü temasını ayrı cümlelerle belirt, İngilizce yazmak daha tutarlı sonuç verir.",
    pricing: "freemium",
    priceNote: "Günde sınırlı ücretsiz şarkı, sınırsız için $10/ay'dan başlıyor",
  },
  "veo-3": {
    name: "Google Veo 3.1",
    vendor: "Google",
